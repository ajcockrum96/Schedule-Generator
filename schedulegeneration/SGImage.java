 ...
 * schedules that would be generated by a given list of SGClassInfo objects
...
public class SGImage {
	 ...
	 * These values are representative of the class number of the SGClassInfo
	...
	/**
	 * <p>
	 * Writes an image key of a given ArrayList of SGClassInfo objects to a given filename.
	 *
	 ...
	 * corresponding to their respective {@link SGClassInfo#number} static fields,
	 ...
	 *
	 * @param filename			the String of the filename to write
	 * @param classes			the ArrayList of SGClassInfo objects to construct a key from
	 */
	static public void writeImageKey(String filename, ArrayList<SGClassInfo> classes) {
		int [][]colors = {
			BLACK,
			RED,
			GREEN,
